...
void counterspell(Spell *spell) {
  ...
  if (auto ptr = dynamic_cast<Fireball *>(spell)) {
    ptr->revealFirepower();
    return;
  }
  if (auto ptr = dynamic_cast<Frostbite *>(spell)) {
    ptr->revealFrostpower();
    return;
  }
  if (auto ptr = dynamic_cast<Thunderstorm *>(spell)) {
    ptr->revealThunderpower();
    return;
  }
  if (auto ptr = dynamic_cast<Waterbolt *>(spell)) {
